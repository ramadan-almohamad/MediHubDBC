...
{
    public partial class iamgeeditform : Form
    {
        BL.MedicalImaging mg = new BL.MedicalImaging();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                mg.UpdateMedicalImaging(panid1, panid, docid, dateTimePicker1.Value, richTextBox1.Text, richTextBox2.Text, filetect.Text);

...
namespace MediHubDB.DAL
{
    internal class DataAccess
    {
        ...
        public DataAccess() => sqlconnection = new SqlConnection("Data Source=.; Database=MediHubDB;Integrated Security=True;Pooling=False");
        // public DataAccess() => sqlconnection = new SqlConnection("Data Source=./SQLEXPRESS; Database=WarehouseDB;Integrated Security=True;Pooling=False");
        //open connection
        public void open()
        {
        ...
        public void execute1(string query)
        {
            ...
            {
                // إذا حدث خطأ، يمكنك إضافة التعامل مع الخطأ هنا
                throw ex;
            }
            finally
            {
                // قم بإغلاق الاتصال بغض النظر عن نجاح أو فشل التنفيذ
                close();
            }
        }
